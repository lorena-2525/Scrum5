...
<div class="background-container">
        <img src="interfaz/InicioDark.jpg" alt="imgmap" usemap="#map" class="background-imagel-fondo">
    </div>
    <map name="map">

        <area shape="rect" coords="245,404,498,581" href="<?= route('InicioDark')?>" alt="logo">
        ...
        <area shape="circle" coords="1604,361,50" href="<?= route('Inicio')?>" alt="modo_oscuro">
        <area shape="poly" coords="370,2758,353,2737,340,2713,340,2682,358,2668,380,2668,400,2680,405,2703,393,2732" href="<?= route('InicioDark')?>" alt="loguito">
                ...
                <div class="calendar">
                    ...
                    <table class="calendar-table">
                        ...
                        <tbody id="calendar-body">
                            <!-- Aquí se generarán las celdas del calendario -->
                        </tbody>
                    </table>
                </div>
